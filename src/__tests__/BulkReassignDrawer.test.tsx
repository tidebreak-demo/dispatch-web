...
import { BulkReassignDrawer } from "../components/BulkReassignDrawer"
...
describe("BulkReassignDrawer", () => {
  ...
  it("shows an unstaffed job without a crew count", () => {
    render(<BulkReassignDrawer {...baseProps} crewCount={0} />)
