...
import { BoardKeyboardLanes } from "../components/BoardKeyboardLanes"
...
describe("BoardKeyboardLanes", () => {
  ...
  it("shows an unstaffed job without a crew count", () => {
    render(<BoardKeyboardLanes {...baseProps} crewCount={0} />)
