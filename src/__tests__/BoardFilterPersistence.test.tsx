...
import { BoardFilterPersistence } from "../components/BoardFilterPersistence"
...
describe("BoardFilterPersistence", () => {
  ...
  it("shows an unstaffed job without a crew count", () => {
    render(<BoardFilterPersistence {...baseProps} crewCount={0} />)
