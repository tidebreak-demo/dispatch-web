...
import { JobSearchBySite } from "../components/JobSearchBySite"
...
describe("JobSearchBySite", () => {
  ...
  it("shows an unstaffed job without a crew count", () => {
    render(<JobSearchBySite {...baseProps} crewCount={0} />)
